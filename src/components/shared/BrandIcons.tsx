...
import type { SocialLink } from '@/data/company'

/* Brand marks as inline SVG paths (simpleicons.org, CC0). lucide removed its brand icons. */
const BRAND_PATHS = {
  linkedin:
...
/** Decorative icon for a social link; the link itself carries the accessible name. */
export function SocialIcon({
  ...
  switch (platform) {
    case 'linkedin':
    case 'instagram':
      return <BrandIcon name={platform} className={className} />
    case 'youtube':
